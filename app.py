    ...
    if not df.empty:
        ...
        with tab1:
            ...
            if len(dilim['Sondaj_No'].unique()) >= 3:
                ...
                st.warning(f"⚠️ {hedef_derinlik}m civarında yeterli veri (en az 3 kuyu) yok. Yüzey çizilemedi.")
        ...
        with tab_gis:
            try:
                ...
                if is_utm:
                    # Türkiye için genel Zone 36N varsayımı
